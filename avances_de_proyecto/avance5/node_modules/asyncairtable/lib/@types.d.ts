...
/** @ignore */
export declare type ConfigKey = keyof Config;
/**
 * Sort Option
 * @example
 * ```
...
/** @ignore */
export declare type ComparisonObject = Record<string, BaseFieldType>;
/** @ignore */
declare type ComparisonFunction = (vals: ComparisonObject) => string;
/** @ignore */
...
/** @ignore */
declare type LogicalFunction = ((expression: QueryObject) => string) | ((args: QueryObject[]) => string);
/** @ignore */
...
/** @ignore */
export declare type QueryField = QueryObject | BaseFieldType;
/** @ignore */
export declare type BaseFieldType = string | number | boolean | null;
/** @ignore */
export declare type Arg = string | number | boolean | SelectOptions | Record<string, unknown>[] | string[] | AirtableUpdateRecord | AirtableUpdateRecord[] | undefined;
/** @ignore */
 ...
 */
export declare type Typecast = boolean;
